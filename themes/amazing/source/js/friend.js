...
$(function () { //获取处理友链数据
    $.getJSON("../json_data/friend.json", function (data) {
        ...
        $('.links-content').append("<div class='friend-title-item'><br>友情链接<br><br><hr></div>");
        ...
        if (notValid.length > 0) {
            $('.links-content').append("<div class='friend-title-item'><br>暂不可访问<br><br><hr></div></div>");
